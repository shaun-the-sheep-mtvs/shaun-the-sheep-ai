...
public class ProfileService {
	...
	@Autowired
	public ProfileService(UserRepository userRepository, RoutineRepository routineRepository,
		PasswordEncoder passwordEncoder, UserskinService userskinService) {
