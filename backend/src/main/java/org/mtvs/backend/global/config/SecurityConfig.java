    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/recommend/session-random").permitAll()
                        .requestMatchers("/api/recommend/session-balanced").permitAll()
                        .requestMatchers("/api/recommend/session-clear").permitAll()
